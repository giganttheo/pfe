...
def main(out_dir_path):
    ...
    for dir in Path('./datasets/jta_dataset/annotations').dirs():
        ...
        coco_dict = {
                'info': {
                    'description': f'JTA 2018 Dataset - Set {dir.basename()}',
        ...
        for anno in dir.files():
            ...
            print()
        out_file_path = out_subdir_path / f'{dir.basename()}.coco.json'
